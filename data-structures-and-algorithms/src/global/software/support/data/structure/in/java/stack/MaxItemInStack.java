...
* 
* The problem is that we have a stack and we want to track
* the largest item during insertion
* 
* - So we want to make sure the getMax() operation has O(1) running time
* 
* - The memory complexity can be O(N) wich means we can use another stack in the implementation
* 
*/

public class MaxItemInStack {

	// this is the stack original
	...
	public void push(int item) {
		...
		// if the item is the largest one so far; we insert it onto stack
