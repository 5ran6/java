 ...
 * of nums being 2. It doesn't matter what you leave beyond the returned length. 
 * For example if you return 2 with nums = [2,2,3,3] or nums = [2,2,0,0], your answer will
 * be accepted.
 * 
 *  Example 2:
...
public class _20_RemoveElements {
	...
	public static int removeElement(int[] nums, int val) {
		...
		int countElementsFounded = 0;
		
		for (int i = 0; i < nums.length; i++) {
			if (nums[i] == val) {
				countElementsFounded++;
			}
		}
		
		int[] numsAux = new int[countElementsFounded];
		int n = 0;
